...
path = "/Users/anilbudak/VSCode/image_processing/test"  # folder with all the class folders
labelFile = 'labels.csv'  # file with all names of classes
batch_size_val = 50  # how many to process together
steps_per_epoch_val = 234
epochs_val = 1
...
for x in range(0, len(myList)):
    myPicList = os.listdir(path + "/" + "data" + str(count))
    for y in myPicList:
        #print(y)
        curImg = cv2.imread(path + "/" + "data" + str(count) + "/" + y)
